...
<template>
  <div>
    <div
      class="absolute z-50 bg-white lg:w-1/3 md:w-1/2 xs:w-full shadow right-0 top-0 bottom-0 m-auto"
      tabindex="-1"
    >
      <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
        <h3 class="font-bold text-gray-800 dark:text-white">Offcanvas title {{ view }}</h3>
      ...
      <div class="p-4">
        ...
        <label for="basic-url" class="mb-2 inline-block text-neutral-700 dark:text-neutral-200"
